import { ArrowLeft, FileText, Calendar, Users, Shield, AlertCircle, Globe } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Terms of service and usage guidelines for the 100xDevs platform
          </p>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                By accessing and using 100xDevs ("the Platform"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                Permission is granted to temporarily access 100xDevs for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                The content on 100xDevs, including but not limited to text, graphics, images, audio, video, and software, is the property of Suryanshu Nabheet or its content suppliers and is protected by copyright and other intellectual property laws.
              </p>
              <p className="text-gray-400 leading-relaxed">
