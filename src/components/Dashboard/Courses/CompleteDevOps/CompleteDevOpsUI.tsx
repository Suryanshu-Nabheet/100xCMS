...
export function CompleteDevOpsUI({ onBack }: CompleteWebDevDevOpsUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="complete-devops">
        ...
        {!selectedModule ? (
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {completeDevOpsData.modules.map((module) => (
                <div
                  key={module.id}
