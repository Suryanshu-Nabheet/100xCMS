...
import { completeWebDevDevOpsBlockchainData } from './data'
import { VideoPlayer } from '../../Content/Video/VideoPlayer'
import { PdfViewer } from '../../Content/Pdf/PdfViewer'

interface CompleteWebDevDevOpsBlockchainUIProps {
  onBack: () => void
}
...
export function CompleteWebDevDevOpsBlockchainUI({ onBack }: CompleteWebDevDevOpsBlockchainUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="complete-web-dev-devops-blockchain">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-2">
                {completeWebDevDevOpsBlockchainData.title}
              </h1>
        ...
        {!selectedModule ? (
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {completeWebDevDevOpsBlockchainData.modules.map((module) => (
                <div
                  key={module.id}
