  ...
  lessons: [
    ...
    },
    {
      ...
      timestamps: [
        ...
        { time: 20, title: 'Variables and Constants' },
    ...
    },
    {
      ...
      timestamps: [
        ...
        { time: 30, title: 'Interface Builder' },
        { time: 60, title: 'Auto Layout' },
        { time: 90, title: 'Storyboards vs Code' }
      ]
    },
    {
      id: 'lesson-4',
    ...
    },
    {
      ...
      timestamps: [
        ...
        { time: 25, title: 'App Store Connect' },
        { time: 50, title: 'Testing and Debugging' },
        { time: 75, title: 'Submission Process' }
      ]
    }
  ]
}
