...
export function IOSDevelopmentUI({ onBack }: IOSDevelopmentUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="ios-development">
      {/* Header */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-2">
                {selectedModule ? selectedModule.title : iosDevelopmentData.title}
              </h1>
        ...
        {!selectedModule ? (
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {iosDevelopmentData.modules.map((module) => (
