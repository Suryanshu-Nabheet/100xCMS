...
export function EthicalHackingUI({ onBack }: EthicalHackingUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="ethical-hacking">
      {/* Header */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-2">
                {selectedModule ? selectedModule.title : ethicalHackingData.title}
              </h1>
        ...
        {!selectedModule ? (
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {ethicalHackingData.modules.map((module) => (
