...
export function CompleteWebDevUI({ onBack }: CompleteWebDevDevOpsUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="complete-web-dev">
        ...
        {!selectedModule ? (
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {completeWebDevData.modules.map((module) => (
                <div
                  key={module.id}
