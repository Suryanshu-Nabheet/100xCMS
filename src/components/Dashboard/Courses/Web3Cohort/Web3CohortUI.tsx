...
import { web3CohortData } from './data'
import { VideoPlayer } from '../../Content/Video/VideoPlayer'
import { PdfViewer } from '../../Content/Pdf/PdfViewer'

interface Web3CohortUIProps {
  onBack: () => void
}

export function Web3CohortUI({ onBack }: Web3CohortUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="web3-cohort">
      {/* Header */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold text-white mb-2">
                {selectedModule ? selectedModule.title : web3CohortData.title}
              </h1>
        ...
        {!selectedModule ? (
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {web3CohortData.modules.map((module) => (
