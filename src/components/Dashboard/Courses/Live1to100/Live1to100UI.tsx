...
export function Live1to100UI({ onBack }: CompleteWebDevDevOpsUIProps) {
  ...
  return (
    <div className="min-h-screen bg-black" data-course-id="live-1-100">
        ...
        {!selectedModule ? (
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {live1to100Data.modules.map((module) => (
                <div
                  key={module.id}
